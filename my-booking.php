...
<input type="radio" name="bike"  value="<?php echo $rb['make'].'//'.$rb['model'].'//'.$cust_id; ?>"> 
<?php echo $rb['bike_reg']; ?>  <?php echo  $rb['make'].'-('.$rb['model'].')' ; ?>
...
echo "<div class='form-group modellist' id='modellist'><label class='col-md-4 control-label' for='model'>Model</label><div class='col-md-5'>";
