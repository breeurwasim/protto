...
if($resArr[payment][status] == "Credit"){
    ...
    //SQL Query
    $sql = "UPDATE jos1n_pass SET transactionid = '$payment_request_id', paymentstatus = 'Paid', status = 'Paid' WHERE id = '$orderid'";
    ...
    //SQL Query
    $sql = "UPDATE jos1n_pass SET transactionid = '$payment_request_id', status = 'Failed', paymentstatus = 'Failed' WHERE id = '$orderid'";
